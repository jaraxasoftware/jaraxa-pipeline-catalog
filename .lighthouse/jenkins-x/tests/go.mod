...
require (
	github.com/jenkins-x-plugins/jx-application v0.0.38
	github.com/jenkins-x-plugins/jx-promote v0.2.4
...
require (
	...
	github.com/jenkins-x-plugins/jx-gitops v0.3.13 // indirect
	github.com/jenkins-x/jx-api/v4 v4.3.2 // indirect
